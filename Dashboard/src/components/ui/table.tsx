...
const TableRow = React.forwardRef<HTMLTableRowElement, React.HTMLAttributes<HTMLTableRowElement>>(
  ({ className, ...props }, ref) => (
    <tr
      ref={ref}
      className={cn(
        "border-b transition-colors hover:bg-slate-100/20 data-[state=selected]:bg-slate-100 dark:border-slate-800 dark:hover:bg-slate-800/20 dark:data-[state=selected]:bg-slate-800",
        className,
      )}
      {...props}
    />
